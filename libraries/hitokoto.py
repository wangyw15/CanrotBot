...
_hitokoto_assets_path = Path(__file__).parent.parent / 'assets/hitokoto'
_version: dict = {}
    ...
    if not _sentences:
        for category in _categories:
            ...
            with open(_hitokoto_assets_path / category["path"], 'r', encoding='utf-8') as f:
                ...
                logger.info(f'hitokoto sentences_bundle {category["name"]} sentences count: {len(_sentences[category["key"]])}')
