        ...
        if soup.select('table:nth-of-type(1)'):
            performance = {
                ...
                'acceptance_id': soup.select_one(
                    '#main-container span:nth-of-type(1)').text.strip()[5:],
                'approval_id': soup.select_one(
                    '#main-container span:nth-of-type(2)').text.strip()[4:],
                'permit_id': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(2)>td:nth-of-type(4)').text.strip(),
                'original_approval_id': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(3)>td:nth-of-type(4)').text.strip(),
                'license_matter': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(1)>td:nth-of-type(2)').text.strip(),
                'organizer': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(2)>td:nth-of-type(2)').text.strip(),
                'name': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(3)>td:nth-of-type(2)').text.strip(),
                'date': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(4)>td:nth-of-type(2)').text.strip(),
                'address': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(5)>td:nth-of-type(2)').text.strip(),
                'actor_count': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(6)>td:nth-of-type(2)').text.strip(),
                'session_number': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(6)>td:nth-of-type(4)').text.strip(),
                'foreigner_short_term': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(7)>td:nth-of-type(2)').text.strip() == '是',
                'content': soup.select_one(
                    'table:nth-of-type(1) tr:nth-of-type(8)>td:nth-of-type(2)').text.strip(),
            }
            actors = []
            for i in soup.select('table:nth-of-type(2) tr:not(:nth-of-type(1))'):
                actors.append({
                    ...
                    'license_number': i.select_one('td:nth-of-type(5)').text.strip(),
                })
            return {
